 ...
 * @author Jack
 * @date on 2019/2/19
 * @describe TODO给MPAndroidChartBar柱状图添加圆角
 * @org 智裳科技
 */
public class BarRoundChartRenderer extends BarLineScatterCandleBubbleRenderer {
    ...
    public BarRoundChartRenderer(BarDataProvider chart, ChartAnimator animator,
